  ...
  if (state.succeeded) {
    return (
      <h1 className="md:text-5xl/tight my-4 max-w-lg text-4xl font-medium text-white ">
        Thank for sending your message
      </h1>
    );
  }
  const menuOne = [
        ...
        <div className="grid grid-cols-2 gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="col-span-2 sm:col-span-1 lg:col-span-3">
            <ul className="flex flex-col gap-3">
              {/* todo -> change the py to alighn about us in small size  */}
              <h5 className="text-default-200 e mb-2 sm:py-10 font-medium lg:text-lg xl:text-xl">
                About Us
              </h5>
            ...
            <div className="bg-primary/20 rounded-xl">
              <div className="p-10">
                ...
                <p className="text-default-200 mb-6 text-base font-medium">
                  Signup and receive the latest news
                </p>
                ...
                <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="email"
                      name="email"
                      className="bg-default-950/60 pe-40 ps-4 h-12 w-full rounded-lg border-white/10 py-4 text-white backdrop-blur-3xl
                      focus:border-white/10 focus:ring-0"
                    />
                    <button
                      type="submit"
                      className="hover:bg-primary-hover hover:border-primary-hover border-primary bg-primary end-[6px] absolute top-[6px] 
                      inline-flex h-9 items-center justify-center gap-2 rounded-md px-6 text-white transition-all"
                ...
                <div>
                  <h6 className="mb-4 text-base text-wihte ">Follow Us</h6>
                  <ul className="flex flex-wrap items-center gap-1">
                    {[
                      ...
                      <li key={index}>
                        <a
                          href="#"
                          className="hover:bg-primary group  inline-flex h-10 w-10 items-center justify-center rounded-lg border 
                          border-white/10 transition-all duration-all duration-500"
                        >
                          <i
